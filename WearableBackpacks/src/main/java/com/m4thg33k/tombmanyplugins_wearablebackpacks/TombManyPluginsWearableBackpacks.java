...
public class TombManyPluginsWearableBackpacks {
    ...
    public static final String DEPENDENCIES = "required-after:forge@[14.23.3.2655,);required-after:wearablebackpacks@[3.1.2,);required-after:tombmanygraves@[1.12-4.1.0,)";
