package com.m4thg33k.tombmanyplugins_thutwearables;
...
@Mod(modid = TombManyPluginsThutWearables.MODID,
        name = TombManyPluginsThutWearables.MODNAME,
        version = TombManyPluginsThutWearables.VERSION,
        dependencies = TombManyPluginsThutWearables.DEPENDENCIES
)
public class TombManyPluginsThutWearables {
    public static final String MODID = "tombmanypluginsthutwearables";
    public static final String VERSION = "@VERSION@";
    public static final String MODNAME = "TombManyPlugins Thut Wearables";
    public static final String DEPENDENCIES = "required-after:forge@[14.23.3.2655,);required-after:thut_wearables@[3.1.6,);required-after:tombmanygraves@[1.12-4.1.0,)";

    @Mod.Instance
    public static TombManyPluginsThutWearables INSTANCE = new TombManyPluginsThutWearables();
    ...
    public void registerSpecialInventories(EventRegisterSpecialInventory e) throws Exception {
        e.registerSpecialInventory(new ThutWearablesSpecialInventory());
    }

    class ThutWearablesSpecialInventory implements ISpecialInventory{
        @Override
        public String getUniqueIdentifier() {
            return "ThutWearablesInventory";
        }
        ...
        public NBTBase getNbtData(EntityPlayer player) {
            return SpecialInventoryHelper.getTagListFromIInventory(WearableHandler.getInstance().getPlayerData(player));
        }
        ...
        public void insertInventory(EntityPlayer player, NBTBase compound, boolean shouldForce) {
            if (compound instanceof NBTTagList){
                ...
                IInventory currentInventory = WearableHandler.getInstance().getPlayerData(player);
