...
public class TombManyPluginsTechguns {
    ...
    public static final String DEPENDENCIES = "required-after:forge@[14.23.3.2655,);required-after:techguns@[2.0.1.1,);required-after:tombmanygraves2api@[1.12-4.1.0,);required-after:tombmanygraves@[1.12-4.1.0,)";
    ...
    public void init(FMLInitializationEvent e){
        new SpecialInventoryTechguns();
    }


    class SpecialInventoryTechguns extends AbstractSpecialInventory{
        @Override
